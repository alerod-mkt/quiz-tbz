...
const ResultScreen: React.FC<ResultScreenProps> = ({ diagnosisLevel, onOfferClick }) => {
    ...
    const handleButtonClick = () => {
        onOfferClick(); // Chama a função de rastreamento (não bloqueante)
        // A navegação é feita dentro de onOfferClick no App.tsx
    };
      ...
      <div className="max-w-5xl w-full">
        ...
        <div className="text-center mb-12 p-8 md:p-10 bg-background rounded-3xl shadow-elegant-xl border border-border">
          ...
          <p className="text-lg md:text-xl text-text-secondary mb-8 leading-relaxed">
            "Estudos de Harvard comprovaram: crianças expostas a brigas constantes desenvolvem os mesmos sintomas de veteranos de guerra. Ansiedade crônica, problemas de concentração, dificuldade para formar relacionamentos saudáveis. O pior: <strong className="font-bold text-secondary">depois dos 12 anos, esses padrões se tornam quase irreversíveis.</strong> Seu filho vai carregar essas cicatrizes para sempre e repetir exatamente o que aprendeu com vocês."
          </p>
          <p className="text-lg md:text-xl text-text-secondary mb-8 leading-relaxed">
